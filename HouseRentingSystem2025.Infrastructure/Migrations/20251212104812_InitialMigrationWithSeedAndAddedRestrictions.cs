...
{
    /// <inheritdoc />
    public partial class InitialMigrationWithSeedAndAddedRestrictions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "House agent identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PhoneNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false, comment: "Agent phone number"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Agent user Id")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6d5800ce-d726-4fc8-83d9-d6b3ac1f591e", 0, "d7490ca1-628c-4be7-b252-42f9596c3195", "guest@mail.com", false, false, null, "guest@mail.com", "guest@mail.com", "AQAAAAIAAYagAAAAEHU+6d64L6UjiGDZxUXjuKyODKeT6wcwDyC5LLrybpfBJcYhaQHBrO84YKEaiLC2rw==", null, false, "4e99e77b-8c43-4eda-99ff-27e4244b1c30", false, "guest@mail.com" },
                    { "dea12856-c198-4129-b3f3-b893d8395082", 0, "1b5e8448-2c10-4bfa-b101-ecdd6065c8cf", "agent@mail.com", false, false, null, "agent@mail.com", "agent@mail.com", "AQAAAAIAAYagAAAAEDuOBzjMNOqiX1QJVIN8BJu9TDC6hnmoA7xZMfo4rp4nxJldKJB+zOTG1SsDhwlDhQ==", null, false, "f53676a9-fe37-46e0-b92c-be019554208e", false, "agent@mail.com" }
                });
